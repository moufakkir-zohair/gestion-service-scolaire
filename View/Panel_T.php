    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
          <li class="active">
			<a href="index.php?action=Panel_Technicien"><i class="icon_house_alt" ></i>Tableau de bord</a>
          </li>
            ...
            <ul class="sub">
              <li><a  href="index.php?action=AfficherEmail">Incident<span  class="notification" style="margin-left: 88px;" ><?= $nbre_email ?></span></a></li>
               <li><a  href="index.php?action=Imprimer">Document<span  class="notification" style="margin-left: 73px;" ><?=  $nbre_document ?></span></a></li>
            </ul>
          </li>
		  ...
		  <li class="sub-menu">
            ...
            <ul class="sub">
			  <li><a href="index.php?action=Afficher_historique">Incident</a></li>
              <li><a  href="index.php?action=HistoriqueImprimer">Document</a></li>
            </ul>
          </li>
