		 ...
		 <div class="row" >
			  <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
				<div class="info-box blue-bg">
				  ...
				  <div class="count"><?=$nbre_utilisateur[0]?></div>
			  ...
			  <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
				<div class="info-box brown-bg">
				  ...
				  <div class="count"><?=$nbre_Salle[0]?></div>
				  <div class="title">Salle</div>
				</div>
				<!--/.info-box-->
			  </div>
			  <!--/.col-->
			  ...
			  <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
				<div class="info-box dark-bg">
				 <i class="fa fa-university"></i>
				  <div class="count"><?=$nbre_Salle_TP[0]?></div>
				  <div class="title">Salle de TP</div>
				</div>
				<!--/.info-box-->
			  </div>
			  ...
			  <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
				<div class="info-box brown-bg" style="background-color: #5a805c;">
				 <i class="fa fa-cog" aria-hidden="true"></i>
				  ...
				  <div class="title">Demande de Service</div>
				</div>
				<!--/.info-box-->
			  </div>

			    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
				<div class="info-box blue-bg" style="background-color: #ba26d4;">
				<i class="fa fa-book" aria-hidden="true"></i>
				  <div class="count"><?=$nbre_document[0]?></div>
				  <div class="title">Demande de Document</div>
				</div>
				<!--/.info-box-->
			  </div>
