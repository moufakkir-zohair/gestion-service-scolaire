      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
		  ...
		  <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a  href="index.php?action=Liste_Professeur">Professeur</a></li>
              <li><a  href="index.php?action=Liste_Etudiant">Etudiant</a></li>
			  <li><a  href="index.php?action=Liste_Technicien">Technicien</a></li>
			  <li><a  href="index.php?action=Liste_salle">salle</a></li>
			  <li><a  href="index.php?action=Liste_salle_TP">salle de TP</a></li>
            </ul>
          </li>
		  ...
		  <li class="sub-menu">
		  <a href="index.php?action=En_Cours_Execution"><i class="fa fa-cog" aria-hidden="true"></i>En cours d'exécution</a>
          </li>
