              ...
              <div class="panel-body">
                <div class="form">
                  <form class="form-validate form-horizontal" >
					...
					<div class="form-group ">
                      <label for="cname" class="control-label col-lg-2">Numéro de salle:</label>
                      <div class="col-lg-10">
						<input class="form-control" id="numero de salle" value="<?php echo $row[2];?>" type="text"  disabled>
                      </div>
                    </div>
					...
					<div class="form-group ">
                      <label for="cname" class="control-label col-lg-2">Technicien:</label>
                      <div class="col-lg-10">
						<input class="form-control"  value="<?php echo $row["5"];?>" type="text"  disabled>
                      </div>
                    </div>
		            ...
		            <div class="form-group">
					  ...
					  <a href="index.php?action=HistoriqueIncident" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Retour </a>
