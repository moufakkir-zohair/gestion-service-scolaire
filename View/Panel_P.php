 ...
 <!-- container section start -->
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
	  <a href="index.html" class="logo">Ensias <span class="lite">Services</span></a>
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
          <li class="active">
			<a href="index.php?action=Panel_Utilisateur"><i class="icon_house_alt" ></i>Tableau de bord</a>
          </li>
            ...
            <ul class="sub">
              <li><a  href="index.php?action=Demande">Salle</a></li>
          ...
          <li class="sub-menu">
		  <a href="index.php?action=Incident"><i class="fa fa-pencil" aria-hidden="true"></i>Incident</a>
          </li>
		   ...
		   <li class="sub-menu">
            ...
            <ul class="sub">
			<li><a  href="index.php?action=AfficherDocument">document<span class="notification" style="margin-left: 75px;"><?= $nbre_document ?></span></a></li>
              <li><a  href="index.php?action=AfficherService">Service<span class="notification" style="margin-left: 90px;"><?= $nbre_service ?></span></a></li>
            </ul>
          </li>
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a  href="index.php?action=EmailIncident">Incident</a></li>
              <li><a  href="index.php?action=EmailDemandeP">Demande</a></li>
